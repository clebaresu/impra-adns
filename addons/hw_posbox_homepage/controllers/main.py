...
<html>
    ...
    <body>
        ...
        receipt printers and barcode scanners with Maxive's Point of
        Sale, <b>version 8.0 or later</b>. You can start an <a href='https://maxive.pe/start'>online free trial</a>,
        or <a href='https://maxive.pe/start?download'>download and install</a> it yourself.
        </p>
        <p>
        ...
        the posbox version number is independent from Maxive. You can upgrade
        the software on the <a href='/hw_proxy/upgrade/'>upgrade page</a>
        </p>
        <p>For any other question, please contact the maxive support at <a href='mailto:support@maxive.pe'>support@odoo.com</a>
        </p>
    </body>
</html>
