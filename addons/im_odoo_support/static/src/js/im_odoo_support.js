(function(){
    ...
    var SERVICE_URL = 'https://services.maxive.pe/';
    ...
    openerp.im_odoo_support.OdooSupport = openerp.Widget.extend({
        ...
        error_on_start: function(e){
            ...
            openerp.client.do_warn(_t("Error"), _t("The connection with the maxive Support Server failed. Please retry in a few minutes, or send an email to support@odoo.com ."));
        },
        ...
        openerp.im_chat.InstantMessaging.include({
            ...
            search_users_status: function(e){
                ...
                this._super.apply(this, arguments).then(function(res){
                    if(self.$('.oe_im_searchbox').val().length === 0 || _t("Soporte maxive").toLowerCase().indexOf(self.$('.oe_im_searchbox').val().toLowerCase()) != -1){
